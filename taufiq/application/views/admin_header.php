...
<nav class="navbar navbar-fixed-top navbar-tulisan">
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo base_url()."index.php/AdminController/admin_buku" ?>">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				<li class="<?php echo $this->session->userdata('active_home'); ?>"><a href="<?php echo base_url()."index.php/AdminController/admin_buku" ?>">Buku</a></li>
				...
				<li class="<?php echo $this->session->userdata('active_kasir'); ?>"><a href="<?php echo base_url()."index.php/AdminController/admin_kasir" ?>">Konsumen</a></li>

				<li class="<?php echo $this->session->userdata('active_transaksi'); ?>"><a href="<?php echo base_url()."index.php/AdminController/admin_data_transaksi" ?>">Transaksi</a></li>
			</ul>
